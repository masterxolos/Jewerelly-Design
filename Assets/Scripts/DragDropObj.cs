    ...
    void Update() {
        ...
        if(touch.phase == TouchPhase.Began) {
            ...
            if(Physics.Raycast(ray, out hit) && (hit.collider.tag == draggingTag))
            {
                ...
                dragging = true;
                if(draggingTag == "bead1")
                {
                    Debug.Log(draggingTag);
                    fakeBeads[0].SetActive(true);
                }
                if (draggingTag == "bead2")
                {
                    fakeBeads[1].SetActive(true);
                }
                if (draggingTag == "bead3")
                {
                    fakeBeads[2].SetActive(true);
                }
                if (draggingTag == "bead4")
                {
                    fakeBeads[3].SetActive(true);
                }
                if (draggingTag == "bead5")
                {
                    fakeBeads[4].SetActive(true);
                }
                if (draggingTag == "bead6")
                {
                    fakeBeads[5].SetActive(true);
                }
        ...
        if (dragging && (touch.phase == TouchPhase.Ended || touch.phase == TouchPhase.Canceled)) {
            ...
            fakeBeads[0].SetActive(false);
            fakeBeads[1].SetActive(false);
            fakeBeads[2].SetActive(false);
            fakeBeads[3].SetActive(false);
            fakeBeads[4].SetActive(false);
            fakeBeads[5].SetActive(false);
        }
    }
